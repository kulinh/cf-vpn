...
if [ "$SECRET_AUTOGENERATED" = 1 ]; then
  warn "AGENT_SHARED_SECRET was auto-generated. Mirror it into D1 so the Worker"
  warn "can authenticate calls to this node:"
  warn ""
  warn "  UPDATE nodes SET agent_secret='$AGENT_SHARED_SECRET' WHERE id='$NODE_ID';"
  warn ""
  warn "(Or include agent_secret in the panel's node-create request.)"
fi
