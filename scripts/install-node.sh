...
if [ "$SECRET_AUTOGENERATED" = 1 ]; then
  warn "AGENT_SHARED_SECRET was auto-generated. Mirror this value into the node's"
  warn "row in D1 (column: agent_shared_secret) so the Worker can authenticate:"
  warn "  $AGENT_SHARED_SECRET"
fi
